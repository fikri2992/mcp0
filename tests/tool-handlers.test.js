...
exports.testToolHandlers = testToolHandlers;
...
async function testToolHandlers() {
    ...
    for (const testCase of testCases) {
        ...
        try {
            ...
            const validatedParams = server.requestValidator.validateToolCall(testCase.toolName, testCase.params);
            ...
            const apiRequest = server.convertToAPIRequest(testCase.toolName, validatedParams);
