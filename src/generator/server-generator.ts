  ...
  constructor(config: ServerGeneratorConfig) {
    this.config = {
      ...
      serverConfig: {
        ...
        maxResponseLength: config.serverConfig?.maxResponseLength ?? 50000,
        allowLocalhost: config.serverConfig?.allowLocalhost ?? false,
  ...
  private createServerStructure(
    ...
    return {
      ...
      configuration: {
        ...
        maxResponseLength: this.config.serverConfig.maxResponseLength ?? 50000,
        allowLocalhost: this.config.serverConfig.allowLocalhost ?? false,
